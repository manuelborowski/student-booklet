...
tables_configuration = {
    'offence' : {
        ...
        'template' : [{'name': 'cb', 'data':'cb', 'order_by': Offence.timestamp, 'width': '1%'},
                      ...
                      {'name': '#', 'data':'student.number', 'order_by': lambda k: k['student']['number'], 'width': '1%'},
                      {'name': 'LKR', 'data':'teacher.code', 'order_by': Teacher.code, 'width': '1%'},
                      {'name': 'KL', 'data':'classgroup.name', 'order_by': Classgroup.name, 'width': '1%'},
