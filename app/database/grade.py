...
from app.database.settings import get_global_setting_sim_dayhour_state, get_global_setting_sim_dayhour
...
def db_filter_grade(teacher_id, dayhour_str, grade_id, lesson_id, changed_item=None):
    ...
    schedule = Schedule(day=d, hour=h, academic_year = get_academic_year(), teacher=teacher, lesson=lesson, grade=grade)
    return schedule
